    ...
    <>
      ...
      >
        ...
        <div className="p-3 mt-auto border-t border-slate-800">
          <button onClick={handleLogout} className={`w-full flex items-center gap-4 px-4 py-3.5 rounded-2xl text-sm font-bold text-red-400 hover:bg-red-500 hover:text-white transition-all ${!isOpen && 'md:justify-center'}`}>
            <FaSignOutAlt className="text-xl flex-shrink-0" />
            <span className={`${!isOpen && 'md:hidden'} whitespace-nowrap`}>Logout</span>
          </button>
        </div>
      </aside>
